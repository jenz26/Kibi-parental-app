// --- START OF FILE src/components/common/icons/GitHubBrandIcon.jsx ---
import React from 'react'; // Buona pratica includerlo

const GitHubBrandIcon = (props) => (
  <svg
...
export default GitHubBrandIcon; // <<<<<<<<<< AGGIUNGI QUESTO EXPORT DEFAULT
// --- END OF FILE src/components/common/icons/GitHubBrandIcon.jsx ---